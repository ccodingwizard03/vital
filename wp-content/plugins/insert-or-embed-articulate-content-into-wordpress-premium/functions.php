...
<script src="<?php echo getPluginUrl()."js/jquery.form.js";?>" ></script>
<script>
...
<p/>
<p/>
<iframe src="http://www.articulatefreak.com/wordpresspluginlatestpremium.html" width="600px" frameborder="0">
</iframe><p/>
...
function quiz_embeder_admin_scripts()
 {
	 if (isset($_GET['page']) && $_GET['page'] == 'articulate_content')
	 {
	 wp_enqueue_script('jquery');
	 wp_enqueue_media();
